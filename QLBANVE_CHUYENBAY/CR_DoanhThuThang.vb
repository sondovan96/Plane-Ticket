...
Public Class CR_DoanhThuThang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QLBANVE_CHUYENBAY.CR_DoanhThuThang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_DoanhThuThang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_DoanhThuThang = New CR_DoanhThuThang()
        rpt.Site = Me.Site
        Return rpt
    End Function
