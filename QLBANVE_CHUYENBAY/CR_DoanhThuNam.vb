...
Public Class CR_DoanhThuNam
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QLBANVE_CHUYENBAY.CR_DoanhThuNam.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_DoanhThuNam
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_DoanhThuNam = New CR_DoanhThuNam()
        rpt.Site = Me.Site
        Return rpt
    End Function
